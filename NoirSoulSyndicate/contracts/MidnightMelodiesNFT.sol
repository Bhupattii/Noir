...
contract MidnightMelodiesNFT is ERC721, Ownable {
    ...
    constructor(address _noirCoin) ERC721("Midnight Melodies NFT", "MMNFT") {
    ...
    function mint(address to, uint256 tokenId) external onlyOwner {
        ...
        musicTracks[tokenId] = MusicTrack("Midnight Melodies", "Aria Harmony®");
